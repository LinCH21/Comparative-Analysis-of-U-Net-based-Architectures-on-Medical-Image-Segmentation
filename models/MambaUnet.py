...
class VSSM(nn.Module):
    def __init__(self, patch_size=4, in_chans=1, num_classes=2, depths=[2, 2, 9, 2], depths_decoder=[2, 9, 2, 2],
...
class MambaUnet(nn.Module):
    def __init__(self, num_classes, in_channel=1, embed_dim=96, mlp_ratio=4):
        super(MambaUnet, self).__init__()

        self.mamba_unet = VSSM(patch_size=4,
                               in_chans=in_channel,
